...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="myFirstBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" Main %CMD_LINE_ARGS%
